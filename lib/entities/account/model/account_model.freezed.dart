...
mixin _$AccountModel {
 ...
 int? get id; String get name; AccountType get type; String? get currency;@JsonKey(name: 'user_id') String get userId;@JsonKey(name: 'current_balance') num get currentBalance;@JsonKey(name: 'created_at') DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,type,currency,userId,currentBalance,createdAt);

@override
String toString() {
  return 'AccountModel(id: $id, name: $name, type: $type, currency: $currency, userId: $userId, currentBalance: $currentBalance, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int? id, String name, AccountType type, String? currency,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'current_balance') num currentBalance,@JsonKey(name: 'created_at') DateTime createdAt
});
...
/// Create a copy of AccountModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = null,Object? type = null,Object? currency = freezed,Object? userId = null,Object? currentBalance = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String name,  AccountType type,  String? currency, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'current_balance')  num currentBalance, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountModel() when $default != null:
return $default(_that.id,_that.name,_that.type,_that.currency,_that.userId,_that.currentBalance,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String name,  AccountType type,  String? currency, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'current_balance')  num currentBalance, @JsonKey(name: 'created_at')  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _AccountModel():
return $default(_that.id,_that.name,_that.type,_that.currency,_that.userId,_that.currentBalance,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String name,  AccountType type,  String? currency, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'current_balance')  num currentBalance, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _AccountModel() when $default != null:
return $default(_that.id,_that.name,_that.type,_that.currency,_that.userId,_that.currentBalance,_that.createdAt);case _:
  return null;
...
class _AccountModel implements AccountModel {
  const _AccountModel({this.id, required this.name, required this.type, this.currency, @JsonKey(name: 'user_id') required this.userId, @JsonKey(name: 'current_balance') required this.currentBalance, @JsonKey(name: 'created_at') required this.createdAt});
...
@override@JsonKey(name: 'current_balance') final  num currentBalance;
...
/// Create a copy of AccountModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = null,Object? type = null,Object? currency = freezed,Object? userId = null,Object? currentBalance = null,Object? createdAt = null,}) {
